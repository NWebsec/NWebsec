...
namespace NWebsec.Mvc.CommonProject.Tests.Helpers
{
    public class CspConfigurationOverrideHelperTests
    {
        ...
        protected IHttpContextWrapper MockContext;
        ...
        {
            _contextHelper.Setup(h => h.GetCspConfigurationOverride(It.IsAny<IHttpContextWrapper>(), reportOnly, true)).Returns((CspOverrideConfiguration)null);
        ...
        public void GetCspElementWithOverrides_OverrideAndConfigFromContext_MergesConfigFromContextAndOverrides(bool reportOnly)
        {
            ...
            _contextHelper.Setup(h => h.GetCspConfiguration(It.IsAny<IHttpContextWrapper>(), reportOnly)).Returns(cspConfig);
            _contextHelper.Setup(h => h.GetCspConfigurationOverride(It.IsAny<IHttpContextWrapper>(), reportOnly, true)).Returns(overrideConfig);
        ...
        {
            var overrideConfig = new CspOverrideConfiguration();
            _contextHelper.Setup(h => h.GetCspConfiguration(It.IsAny<IHttpContextWrapper>(), reportOnly)).Returns((ICspConfiguration)null);
            _contextHelper.Setup(h => h.GetCspConfigurationOverride(It.IsAny<IHttpContextWrapper>(), reportOnly, true)).Returns(overrideConfig);
            _directiveConfigMapper.Setup(m => m.MergeOverrides(overrideConfig, It.IsAny<ICspConfiguration>()));
        ...
        {
            var overrideConfig = new CspOverrideConfiguration();
            _contextHelper.Setup(h => h.GetCspConfigurationOverride(It.IsAny<IHttpContextWrapper>(), reportOnly, false)).Returns(overrideConfig);
        ...
        public void GetCspScriptNonce_ScriptNonceRequestedNoOverrides_ClonesBaseConfigAndOverridesNonce()
        {
            ...
            _contextHelper.Setup(h => h.GetCspConfiguration(It.IsAny<IHttpContextWrapper>(), false)).Returns(cspConfig);
            _contextHelper.Setup(h => h.GetCspConfiguration(It.IsAny<IHttpContextWrapper>(), true)).Returns(cspConfigReportOnly);
            _contextHelper.Setup(h => h.GetCspConfigurationOverride(It.IsAny<IHttpContextWrapper>(), false, false)).Returns(overrideConfig);
            _contextHelper.Setup(h => h.GetCspConfigurationOverride(It.IsAny<IHttpContextWrapper>(), true, false)).Returns(overrideConfigReportOnly);
            //No overrides
