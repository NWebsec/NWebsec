...
{
    [TestFixture]
    public class HttpHeaderOverrideHelperTests
    {
        private Mock<IContextHelper> _contextHelper;
        ...
        private HttpHeaderOverrideHelper _overrideHelper;
        ...
        public void Setup()
        {
            _contextHelper = new Mock<IContextHelper>(MockBehavior.Strict);
            ...
            _overrideHelper = new HttpHeaderOverrideHelper(_contextHelper.Object,
