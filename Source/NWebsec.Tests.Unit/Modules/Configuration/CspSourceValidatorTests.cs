...
namespace NWebsec.Tests.Unit.Modules.Configuration
{
    ...
    public class CspSourceValidatorTests
    {
        ...
        {
            Assert.DoesNotThrow(() => validator.Validate("https:"));
        }
        
        [Test]
        public void Validate_SchemeAndHost_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("https://www.nwebsec.com"));
        }

        [Test]
        public void Validate_SchemeHostAndPath_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("https://www.nwebsec.com/some/path"));
        }

        [Test]
        public void Validate_SchemeHostAndPort_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("https://www.nwebsec.com:8000"));
        }

        [Test]
        public void Validate_SchemeHostPortAndPath_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("https://www.nwebsec.com:8000/some/path"));
        }
        ...
        {
            Assert.DoesNotThrow(() => validator.Validate("https://*.nwebsec.com"));
        }

        [Test]
        public void Validate_SchemeWildcardHostAndPath_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("https://*.nwebsec.com/some/path"));
        }

        [Test]
        public void Validate_SchemeWildcardHostAndPort_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("https://*.nwebsec.com:8000"));
        }

        [Test]
        public void Validate_SchemeWildcardHostPortAndPath_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("https://*.nwebsec.com:8000/some/path"));
        }
        ...
        {
            Assert.DoesNotThrow(() => validator.Validate("myhost"));
        }

        [Test]
        public void Validate_Host_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("www.demo-nwebsec.com"));
        }

        [Test]
        public void Validate_HostAndPath_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("www.nwebsec.com/some/path"));
        }

        [Test]
        public void Validate_HostAndPort_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("www.nwebsec.com:8000"));
        }

        [Test]
        public void Validate_HostPortAndPath_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("www.nwebsec.com:8000/some/path"));
        }

        [Test]
        public void Validate_HostAndWildCardPort_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("www.nwebsec.com:*"));
        }
        ...
        {
            Assert.DoesNotThrow(() => validator.Validate("*.nwebsec.com"));
        }

        [Test]
        public void Validate_WildcardHostAndPath_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("*.nwebsec.com/some/path"));
        }

        [Test]
        public void Validate_WildcardTld_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("*.com"));
        }

        [Test]
        public void Validate_WildcardHostAndPort_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("*.nwebsec.com:8000"));
        }

        [Test]
        public void Validate_WildcardHostPortAndPath_NoException()
        {
            Assert.DoesNotThrow(() => validator.Validate("*.nwebsec.com:8000/some/path"));
        }
        ...
        {
            Assert.Throws<InvalidCspSourceException>(() => validator.Validate("0https:"));
        }

        [Test]
        public void Validate_InvalidSchemeHost_ThrowsException()
        {
            Assert.Throws<InvalidCspSourceException>(() => validator.Validate("0https://www.nwebsec.com"));
        }

        [Test]
        public void Validate_WildcardTld_ThrowsException()
        {
            Assert.Throws<InvalidCspSourceException>(() => validator.Validate("www.nwebsec.*"));
        }

        [Test]
        public void Validate_WildcardWithinHostname_ThrowsException()
        {
            Assert.Throws<InvalidCspSourceException>(() => validator.Validate("www.*.com"));
        }

        [Test]
        public void Validate_SchemeAndWildcardWithinHostname_ThrowsException()
        {
            Assert.Throws<InvalidCspSourceException>(() => validator.Validate("https://www.*.com"));
        }

        [Test]
        public void Validate_SchemeHostAndDoublePort_ThrowsException()
        {
            Assert.Throws<InvalidCspSourceException>(() => validator.Validate("https://www.nwebsec.com:80:80"));
        }

        [Test]
        public void Validate_SchemeHostAndNegativePortNumber_ThrowsException()
        {
            Assert.Throws<InvalidCspSourceException>(() => validator.Validate("https://www.nwebsec.com:-80"));
        }

        [Test]
        public void Validate_SchemeHostAndInvalidPortNumber_ThrowsException()
        {
            Assert.Throws<InvalidCspSourceException>(() => validator.Validate("https://www.nwebsec.com:65536"));
        }
    }
}
